<?php
        ...
        if ($_POST["todo"] == "register") {
            ...
            if ($shouldProcessFurther) {
                ...
                if ($shouldProcessFurther) {
                    ...
                    $msg = "We have received your application for membership at Sugoi. We hope you enjoy your stay.\n\n*** This is an automatically generated email, please do not reply ***";
                    $msg = wordwrap($msg,70);
                    mail($email,"Registration at Sugoi Successful",$msg);
                } else {
                    $query = 'ROLLBACK;';
                    $conn->query($query);
                    include_once ('./php/error.php');
    ...
    if (isset($_SESSION["username"])) {
        ...
        echo '<span class="button submenu__button" id="submenu__button--login"><strong>Log In</strong></span>';
    }
?>
				...
				<div class="twelve column">
					<div class="row nav__menu">
						...
						<form class="menu__search" method="get" action="shop.php">
							<input type="text" name="searchstring" class="input--text search__input u-flex-1" placeholder="Search menu">
