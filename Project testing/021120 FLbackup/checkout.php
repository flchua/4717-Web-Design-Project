        ...
        if (isset($_POST["buy"])) {
            ...
            if ($shouldProcessFurther) {
                ...
                if ($create_account || isset($_SESSION["email"])) {
                    ...
                    $msg = "We have received your transaction at Sugoi. Thank you for shopping with us.\r\n\r\n*** This is an automatically generated email, please do not reply ***";
                    $msg = wordwrap($msg,70);
                    mail($email,"Transaction at Sugoi Successful",$msg);
                }

                $msg = "A customer (ID:" . $customer_id . ") has made a transaction (ID:" . $order_id . ").\r\n\r\n*** This is an automatically generated email, please do not reply ***";
                $msg = wordwrap($msg,70);
                mail( "f35ee@EE-IM-4717","New Transaction at Sugoi",$msg);
